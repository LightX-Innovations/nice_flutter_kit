...
abstract class NiceBaseListDataFilterProvider<D extends FreezedClass> {
...
class NiceBaseListDataFilterApiProvider<D extends FreezedClass> implements NiceBaseListDataFilterProvider<D> {
